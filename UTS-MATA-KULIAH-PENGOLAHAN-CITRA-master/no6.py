...
cover = Image.open('repo_file/Raphael.jpg').convert('RGB')
stego = lsb.hide('repo_file/Raphael.jpg', 10*"LSB data hiding with Stegano").convert('RGB')
stego.save('repo_file/Raphael.jpg')
print(lsb.reveal('repo_file/Raphael.jpg'))
